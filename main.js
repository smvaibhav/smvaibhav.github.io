...
module.exports = "table, tr{\n  width: 100%;\n  border-radius: 5px;\n  border-collapse: collapse;\n  border: 1px solid #c9c9c9;\n}\n\nth{\n  text-align: left;\n  padding: 10px;\n  background-color: #f2f2f2;\n}\n\ntd{\n  padding: 12px;\n  background-color: white;\n}\n\n.todo-form {\n  min-width: 150px;\n  max-width: 500px;\n  width: 100%;\n}\n\n.todo-full-width {\n  width: 100%;\n}\n\n.alert {\n  padding: 15px;\n  margin-top: 20px;\n}\n\nbutton{\n  margin: 3px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ToDoListComponent = /** @class */ (function () {
    ...
    ToDoListComponent.prototype.addTodo = function () {
        var now = moment__WEBPACK_IMPORTED_MODULE_2__(this.model.tododue).format('ddd, MMM DD');
        console.log(now);
        console.log(this.model);
        this.mytodos.push({ mtodo: this.model.mtodo,
            tododue: now,
            todonotes: this.model.todonotes,
            tododone: this.model.tododone });
        this.model = {};
        this.msg = "Yes! New ToDo Add Success...";
        this.showclk = !this.showclk;
        this.buttonName = "add";
    };
    ToDoListComponent.prototype.deleteTodo = function (i) {
        this.mytodos.splice(i, 1);
        this.msg = "Hmmm! You've done one Task Successfully...";
    };
    ToDoListComponent.prototype.editTodo = function (k) {
        this.editclk = !this.editclk;
        this.model2.mtodo = this.mytodos[k].mtodo;
        this.model2.tododue = this.mytodos[k].tododue;
        this.model2.todonotes = this.mytodos[k].todonotes;
        this.model2.tododone = this.mytodos[k].tododone;
        this.myValue = k;
    };
    ToDoListComponent.prototype.updateTodo = function () {
        var k = this.myValue;
        for (var i = 0; i < this.mytodos.length; i++) {
            if (i == k) {
                this.mytodos[i] = this.model2;
                this.model2 = {};
                this.msg = "Yes! You've Update Your Todo Successfully...";
                this.editclk = !this.editclk;
            }
        }
    };
    ToDoListComponent.prototype.clickMe = function () {
        this.msg = "";
    };
    ...
    ToDoListComponent.prototype.canceln = function () {
        this.showclk = !this.showclk;
        this.buttonName = "add";
    };
